...
#define FILENAME_TAKEN -9
#define ERROR_USER_NOT_OWNER	-10
#define ERROR_USER_NOT_FOUND	-11
#define ERROR_TOO_MANY_USERS	-12
#define ERROR_USERNAME_TAKEN	-13
#define ERROR_PASSWORD			-14
#define FILENAME_TAKEN -15
